...
impl PredictionResourceRelationshipsScheduleData {
  ...
  pub fn with__type(mut self, _type: String) -> PredictionResourceRelationshipsScheduleData {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> PredictionResourceRelationshipsScheduleData {
    self.id = Some(id);
    self
  }
