...
impl Route {
  ...
  pub fn with_links(mut self, links: ::models::VehicleLinks) -> Route {
    self.links = Some(links);
    self
  }
  ...
  pub fn with_included(mut self, included: Vec<::models::VehicleIncluded>) -> Route {
    self.included = Some(included);
    self
  }
  ...
  pub fn set_data(&mut self, data: ::models::RouteResource) {
    self.data = data;
  }

  pub fn with_data(mut self, data: ::models::RouteResource) -> Route {
    self.data = data;
    self
  }

  pub fn data(&self) -> &::models::RouteResource {
    &self.data
  }
