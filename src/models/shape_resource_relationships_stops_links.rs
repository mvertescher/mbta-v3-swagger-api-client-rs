...
pub struct ShapeResourceRelationshipsStopsLinks {
...
impl ShapeResourceRelationshipsStopsLinks {
  pub fn new() -> ShapeResourceRelationshipsStopsLinks {
  ...
  pub fn with__self(mut self, _self: String) -> ShapeResourceRelationshipsStopsLinks {
    self._self = Some(_self);
    self
  }
  ...
  pub fn with_related(mut self, related: String) -> ShapeResourceRelationshipsStopsLinks {
    self.related = Some(related);
    self
  }
