...
pub struct AlertResourceRelationshipsFacilityLinks {
...
impl AlertResourceRelationshipsFacilityLinks {
  pub fn new() -> AlertResourceRelationshipsFacilityLinks {
  ...
  pub fn with__self(mut self, _self: String) -> AlertResourceRelationshipsFacilityLinks {
    self._self = Some(_self);
    self
  }
  ...
  pub fn with_related(mut self, related: String) -> AlertResourceRelationshipsFacilityLinks {
    self.related = Some(related);
    self
  }
