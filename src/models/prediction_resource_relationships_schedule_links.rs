...
impl PredictionResourceRelationshipsScheduleLinks {
  ...
  pub fn with__self(mut self, _self: String) -> PredictionResourceRelationshipsScheduleLinks {
    self._self = Some(_self);
    self
  }
  ...
  pub fn with_related(mut self, related: String) -> PredictionResourceRelationshipsScheduleLinks {
    self.related = Some(related);
    self
  }
