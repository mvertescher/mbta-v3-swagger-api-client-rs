...
pub struct TripResourceRelationshipsShapeLinks {
...
impl TripResourceRelationshipsShapeLinks {
  pub fn new() -> TripResourceRelationshipsShapeLinks {
  ...
  pub fn with__self(mut self, _self: String) -> TripResourceRelationshipsShapeLinks {
    self._self = Some(_self);
    self
  }
  ...
  pub fn with_related(mut self, related: String) -> TripResourceRelationshipsShapeLinks {
    self.related = Some(related);
    self
  }
