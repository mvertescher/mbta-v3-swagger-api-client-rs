...
impl PredictionResourceRelationshipsVehicleData {
  ...
  pub fn with__type(mut self, _type: String) -> PredictionResourceRelationshipsVehicleData {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> PredictionResourceRelationshipsVehicleData {
    self.id = Some(id);
    self
  }
