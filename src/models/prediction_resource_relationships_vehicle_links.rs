...
pub struct PredictionResourceRelationshipsVehicleLinks {
...
impl PredictionResourceRelationshipsVehicleLinks {
  pub fn new() -> PredictionResourceRelationshipsVehicleLinks {
  ...
  pub fn with__self(mut self, _self: String) -> PredictionResourceRelationshipsVehicleLinks {
    self._self = Some(_self);
    self
  }
  ...
  pub fn with_related(mut self, related: String) -> PredictionResourceRelationshipsVehicleLinks {
    self.related = Some(related);
    self
  }
