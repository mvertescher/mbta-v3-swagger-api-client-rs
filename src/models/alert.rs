...
impl Alert {
  ...
  pub fn with_links(mut self, links: ::models::VehicleLinks) -> Alert {
    self.links = Some(links);
    self
  }
  ...
  pub fn with_included(mut self, included: Vec<::models::VehicleIncluded>) -> Alert {
    self.included = Some(included);
    self
  }
  ...
  pub fn set_data(&mut self, data: ::models::AlertResource) {
    self.data = data;
  }

  pub fn with_data(mut self, data: ::models::AlertResource) -> Alert {
    self.data = data;
    self
  }

  pub fn data(&self) -> &::models::AlertResource {
    &self.data
  }
